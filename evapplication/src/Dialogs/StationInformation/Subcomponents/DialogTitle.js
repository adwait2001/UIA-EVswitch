...
const DialogTitle = withStyles(styles)((props) => {
  ...
  return (
    <MuiDialogTitle className="flex" disableTypography id="station-information-dialog-title">
      <div className="flex" id="station-id ">
        ...
        >
          <Typography variant="subtitle2">REDIRECT TO OPEN CHARGE MAP : {station.ID}</Typography>
        </a>
      </div>
