...
mapboxgl.accessToken = "pk.eyJ1IjoiYWR3YWl0MDkiLCJhIjoiY2w2dzBqYmtkMDFpOTNpcW1wYmJjYXZreiJ9.pZ206Nvhb-M1uhjoIUBZ4g";
...
const Map = () => {
  ...
  useEffect(() => {
    ...
    const getStationsByBounds = () => {
      ...
      axios
        .get(
          `https://api.openchargemap.io/v3/poi/?output=json&maxresults=1000&verbose=true&boundingbox=${LatLong1},${LatLong2}&key=${process.env.REACT_APP_OCM_KEY}`
        )
        .then((res) => {
          clearStationMarkers();
    ...
    const addStationMarkers = (stations) => {
      stations.forEach((station) => {
        ...
        el.src = "https://img.icons8.com/pastel-glyph/64/null/park-and-charge.png"
        console.log(el)
